...
using CoreAuditProcessingService = AuditHistoryExtractorPro.Core.Services.AuditProcessingService;
using CoreAuditProcessingServiceInterface = AuditHistoryExtractorPro.Core.Services.IAuditProcessingService;
...
using CoreAuditComparisonServiceInterface = AuditHistoryExtractorPro.Core.Services.IAuditComparisonService;
using CoreAuditComparisonService = AuditHistoryExtractorPro.Core.Services.AuditComparisonService;
...
builder.Services.AddSingleton<CoreAuditProcessingServiceInterface, CoreAuditProcessingService>();
builder.Services.AddSingleton<CoreAuditComparisonServiceInterface, CoreAuditComparisonService>();
